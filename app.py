...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://{}:{}@{}/{}'.format(app.config['POSTGRES_USER'],app.config['POSTGRES_PASSWORD'],app.config['POSTGRES_URL'],app.config['POSTGRES_DB'])
